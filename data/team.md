...
teamData : {
	...
	publicity: {
		...
		team: [
			...
			{
				coverPic: '/assets/profile_pics/soumya-teotia.jpg',
				name: 'Soumya Teotia',
				subtitle: 'ACM BPHC',
				github: 'https://github.com/Soumyaa21',
			},
			{
				coverPic: '/assets/profile_pics/moksh-papneja.jpeg',
				name: 'Moksh Papneja',
				subtitle: 'ACM BPHC',
				github: 'https://github.com/mokshpapneja',
				facebook: 'https://m.facebook.com/people/Moksh-Papneja/100005537474695',
			},
		]
	},
	content: {
	...
	events: {
		...
		team: [
			{
				coverPic: '/assets/profile_pics/shubhankar-vivek-shastri.jpg',
				name: 'Shubhankar Vivek Shastri',
				subtitle: 'ACM BPHC',
				github: 'https://github.com/Shubhankar7343',
				linkedin: 'https://www.linkedin.com/in/shubhankar-vivek-shastri-a0a043205/',
				facebook: 'https://www.facebook.com/shubhankar.vivekshastri'
			},
			{
				coverPic: '/assets/profile_pics/dharmesh-varshney.jpg',
